...
INSERT INTO courses (term, coursenum, coursetype, coursename, instructor, enrollnum, taquota) VALUES ('Winter2022', 'COMP421', 'Science', 'Database', 'Joseph D', 400, 20);
INSERT INTO courses (term, coursenum, coursetype, coursename, instructor, enrollnum, taquota) VALUES ('Winter2022', 'COMP424', 'Science', 'AI', 'Jackie C', 300, 8);
INSERT INTO courses (term, coursenum, coursetype, coursename, instructor, enrollnum, taquota) VALUES ('Winter2022', 'COMP307', 'Science', 'Web Dev', 'Joseph V', 100, 5);

-- tacohort
INSERT INTO tacohort (term, tname, tid, legalname, email, ugrad, supervisor, priority, hours, applieddate, location, phone, degree, coursesapplied, flexible, notes) VALUES ('Winter2021', 'Claire', '260000000', 'Youyou Yang', 'youyou.yang@mail.mcgill.ca', 1, 'Joseph V', 1, 90, '2020-12-01', 'Canada', '5140000000', 'Bachelor of Science', 'COMP307', 1, 'good');
